...
NAME = "lstm_v9_c_class_FORE" #this is the name of the python file for logging purposes

k = open("../Genetic/lstm_v9_c_class_FOREbest.csv", "r")
...
with tf.Session() as sess:
    ...
    for epoch in range(epochs):
        ...
        if epoch % 50 == 0 and epoch > epochs-(50*hyp.FINALJUMP): #this finds entropic local minima at the end and saves them
            ...
            saver.save(sess, "../Graphs_and_Results/" + NAME + "/models/V9Genetic_FORE", global_step=epoch)
