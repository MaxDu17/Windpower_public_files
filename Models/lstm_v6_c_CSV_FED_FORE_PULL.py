...
NAME = "lstm_v6_c_class_FORE_PULL" #this is the name of the python file for logging purposes

k = open("../Genetic/lstm_v6_c_class_FOREbest.csv", "r")
...
with tf.name_scope("weights_and_biases"):
    ...
    B_Forget_and_Input = tf.Variable(tf.constant(shape=[1, cell_dim], value = 3, dtype = tf.float32), name="forget_and_input_bias")
