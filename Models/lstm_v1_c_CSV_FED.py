...
NAME = "lstm_v1_c_class" #this is the name of the python file for logging purposes
...
with tf.Session() as sess:
    ...
    for epoch in range(epochs):
        ...
        if epoch % 50 == 0 and epoch > epochs-(50*hyp.FINALJUMP): #this finds entropic local minima at the end and saves them
            ...
            saver.save(sess, "../Graphs_and_Results/" + NAME + "/models/V1Genetic", global_step=epoch)
