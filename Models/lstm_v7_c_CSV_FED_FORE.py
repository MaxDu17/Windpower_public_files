...
NAME = "lstm_v7_c_class_FORE" #this is the name of the python file for logging purposes
...
with tf.name_scope("weights_and_biases"):
    W_Forget_and_Input = tf.Variable(tf.random_normal(shape=[hidden_dim + cell_dim + 21, cell_dim]),
