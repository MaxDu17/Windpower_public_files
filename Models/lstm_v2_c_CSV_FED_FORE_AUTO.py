...
NAME = "lstm_v2_c_class_FORE_AUTO" #this is the name of the python file for logging purposes

k = open("../Genetic/lstm_v2_c_class_FORE_AUTObest.csv", "r")
...
def step(last_state, X):
    with tf.name_scope("to_gates"):
        ...
        compressed_input = tf.add(tf.matmul(X, W_Compression, name="compression_mult"), B_Compression,
...
with tf.Session() as sess:
    ...
    for epoch in range(epochs):
        ...
        if epoch % 50 == 0 and epoch > epochs-(50*hyp.FINALJUMP): #this finds entropic local minima at the end and saves them
            ...
            saver.save(sess, "../Graphs_and_Results/" + NAME + "/models/V2Genetic_FORE_AUTO", global_step=epoch)
