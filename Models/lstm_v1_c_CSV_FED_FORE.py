...
NAME = "lstm_v1_c_class_FORE" #this is the name of the python file for logging purposes
...
with tf.name_scope("prediction"):
    ...
    raw_output = tf.reduce_sum(current_hidden)
...
with tf.Session() as sess:
    ...
    for epoch in range(epochs):
        ...
        if epoch % 50 == 0 and epoch > epochs-(50*hyp.FINALJUMP): #this finds entropic local minima at the end and saves them
            ...
            saver.save(sess, "../Graphs_and_Results/" + NAME + "/models/V1Genetic_FORE", global_step=epoch)
