...
NAME = "lstm_v2_c_class_FORE_PULL" #this is the name of the python file for logging purposes
...
with tf.name_scope("weights_and_biases"):
    ...
    B_Forget = tf.Variable(tf.constant(shape=[1, cell_dim], value = 3, dtype = tf.float32), name="forget_bias")
